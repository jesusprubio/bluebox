...
module.exports = (function () {
    ...
    return {
        ...
        info : {
            name        : 'amiDadhiShowChannels',
            description : 'Use the Asterisk Manager service (AMI) to get channels (DADHI) of the server',
            options     : {
                target : {
        ...
        run : function (options, callback) {
            ...
            ami.on('namiConnected', function () {
                var action = new namiLib.Actions.DahdiShowChannels();
