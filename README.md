...
Bluebox-ng
==========
Bluebox-ng is a GPL VoIP/UC vulnerability scanner written using Node.js powers. My 2 cents to improve security practices in these environments and to make Node.js still more awesome. ;)
