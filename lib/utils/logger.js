...
module.exports.infoHigh = (str) => {
  process.stdout.write(`${clc.xterm(63)(str)}\n`);
};

module.exports.highlight = (str) => {
  process.stdout.write(`${clc.xterm(202)(str)}\n`);
};

module.exports.result = (str) => {
...
module.exports.welcome = (str) => {
  process.stdout.write(`${clc.bold.xterm(202)(str)}\n`);
};
