...
module.exports.help = {
  description: 'Use the Asterisk Manager service (AMI) to locate voicemail users',
  options: {
    target: {
      type: 'ip',
...
module.exports.run = (options, callback) => {
  ...
  ami.on('namiConnected', () => {
    const action = new namiLib.Actions.VoicemailUsersList();
